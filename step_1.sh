...
$BASE/encode/step_2.sh $filepath $filename $encodeinfo
...
#if [ $channelid -eq 30 ]; then
nohup $BASE/encode/step_3.sh $filepath v1080p $filename mp4 >> $BASE/encode/encode.log&
#fi

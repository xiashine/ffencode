...
def package_hds_files(in_mp4,contentid,bitrate,out_path,manifest_file=None):
    ...
    cmd=['/usr/local/f4fpackager/f4fpackager','--input-file='+tmpfile,'--content-id='+contentid,'--common-key=/usr/local/f4fpackager/m1905FlashAccess/m1905-license.key','--license-server-url=http://drmfa.m1905.com/flashaccessserver/sampletenant/','--license-server-cert=/usr/local/f4fpackager/m1905FlashAccess/m1905-license.der','--transport-cert=/usr/local/f4fpackager/m1905FlashAccess/m1905-transport.der','--packager-credential=/usr/local/f4fpackager/m1905FlashAccess/m1905-packager.pfx','--credential-pwd=1qazxsw2M1905packager','--policy-file=/usr/local/f4fpackager/m1905FlashAccess/ad-policy.pol','--bitrate='+str(bitrate),'--output-path='+out_path]
